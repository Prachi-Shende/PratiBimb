...
//         PRATI
//       </span>
//       <span className="text-red-600 font-black text-2xl tracking-tighter leading-none">
//         BIMB
//       </span>
//       <div className="absolute -bottom-1 left-0 w-0 group-hover:w-full h-[2px] bg-red-600 transition-all duration-300" />
//     </div>
//     <div className="bg-red-600 text-white text-[10px] font-black px-1.5 py-0.5 tracking-widest">
//       '26
//     </div>
//   </Link>
// );
...
//     `relative px-3 py-2 text-sm font-bold tracking-widest uppercase transition-colors duration-200 group ${isActive(path) ? 'text-red-500' : 'text-gray-300 hover:text-white'
//     }`;

//   return (
//     <nav
//       className={`fixed w-full z-50 transition-all duration-500 ${scrolled
//         ? 'bg-black/95 backdrop-blur-md border-b border-red-900/30 shadow-[0_4px_30px_rgba(220,0,0,0.08)]'
...
//               Home
//               <span className={`absolute bottom-0 left-3 right-3 h-[2px] bg-red-600 transition-all duration-300 ${isActive('/') ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'}`} />
//             </Link>
...
//                 className={`flex items-center gap-1 px-3 py-2 text-sm font-bold tracking-widest uppercase transition-colors duration-200 ${clubsOpen ? 'text-red-500' : 'text-gray-300 hover:text-white'}`}
//               >
//                 Clubs
...
//               {clubsOpen && (
//                 <div className="absolute top-full left-0 mt-2 w-48 bg-black border border-red-900/40 shadow-[0_8px_30px_rgba(220,0,0,0.15)]">
//                   {/* Dropdown accent */}
//                   <div className="h-[2px] w-full bg-red-600" />
//                   <Link
//                     to="/clubs/edc"
//                     onClick={() => setClubsOpen(false)}
//                     className="block px-4 py-3 text-sm font-bold tracking-widest uppercase text-gray-300 hover:text-white hover:bg-red-950/30 border-b border-white/5 transition-colors"
//                   >
//                     EDC
//                   </Link>
//                   <Link
//                     to="/clubs/obsidian"
//                     onClick={() => setClubsOpen(false)}
//                     className="block px-4 py-3 text-sm font-bold tracking-widest uppercase text-gray-300 hover:text-white hover:bg-red-950/30 transition-colors"
//                   >
//                     Obsidian
//                   </Link>
//                 </div>
...
//                 className={`flex items-center gap-1 px-3 py-2 text-sm font-bold tracking-widest uppercase transition-colors duration-200 ${pastOpen ? 'text-red-500' : 'text-gray-300 hover:text-white'}`}
//               >
//                 The Past
...
//               About Us
//               <span className={`absolute bottom-0 left-3 right-3 h-[2px] bg-red-600 transition-all duration-300 ${isActive('/about') ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'}`} />
//             </Link>
//             {/* Theme */}
//             <Link to="/theme" className={navLinkClass('/theme')}>
//               Theme
//               <span className={`absolute bottom-0 left-3 right-3 h-[2px] bg-red-600 transition-all duration-300 ${isActive('/theme') ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'}`} />
//             </Link>
...
//               className="text-gray-300 hover:text-white focus:outline-none p-1 border border-white/10 hover:border-red-600/50 transition-colors"
//             >
...
//                   <Link to="/clubs/edc" onClick={() => { setIsOpen(false); setClubsOpen(false); }} className="block px-3 py-2 text-sm font-bold tracking-widest uppercase text-gray-400 hover:text-red-500">EDC</Link>
//                   <Link to="/clubs/obsidian" onClick={() => { setIsOpen(false); setClubsOpen(false); }} className="block px-3 py-2 text-sm font-bold tracking-widest uppercase text-gray-400 hover:text-red-500">Obsidian</Link>
//                 </div>
//               )}
//             </div>
...
//                   <Link to="/past/prati25" onClick={() => { setIsOpen(false); setPastOpen(false); }} className="block px-3 py-2 text-sm font-bold tracking-widest uppercase text-gray-400 hover:text-red-500">Prati'25</Link>
//                 </div>
//               )}
//             </div>
...
//               to="/about"
//               onClick={() => setIsOpen(false)}
//               className="block px-3 py-3 text-sm font-bold tracking-widest uppercase text-gray-300 hover:text-red-500"
//             >
//               About Us
//             </Link>
//             <Link
